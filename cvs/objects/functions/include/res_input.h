 ...
 * \file res_input.h
 * \ingroup Objects
 * \brief RESInput class header file.
...
/*! 
 * \ingroup Objects
 * \brief Defines a single res input to a MiniCAM production function.
 * \details RES market inputs, copying the format for an energy input.
 *
 *          <b>XML specification for RESInput</b>
 *          - XML name: \c res-input
 ...
 *                              efficiency can be input).
 *              - \c calibrated-value RESInput::mCalibrationInput
 *              - \c income-elasticity RESInput::mIncomeElasticity
 *              - \c tech-change RESInput::mTechChange
 *
 * \author Josh Lurz
 */
class RESInput: public MiniCAMInput
{
public:
...
protected:
    RESInput( const RESInput& aOther );
