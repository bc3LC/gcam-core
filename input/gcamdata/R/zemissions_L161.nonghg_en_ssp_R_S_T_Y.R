  ...
  .default="NA"
    ...
    out_df[["1&5"]] %>%
      ...
      add_precursors("emissions/A_regions",
                     ...
                     "emissions/GAINS/SSPs_IMAGE_emf_agg_cle_rev_2025-07-02",
                     "emissions/GAINS/SSPs_IMAGE_emf_agg_middle_2025-07-02",
                     "emissions/GAINS/drop_folder_vintaged_EF_sectors",
                     "L102.pcgdp_thous90USD_Scen_R_Y",
                     "L112.nonghg_tgej_R_en_S_F_Yh_infered_combEF_AP",
                     "L114.bcoc_tgej_R_en_S_F_2000",
