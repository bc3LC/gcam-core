...
modeltime.HECTOR_EMISSIONS_YEAR  <- 2023
...
# Volumetric Conversions for CCS Rate Limits from O&G industry
...
socioeconomics.SSP_DB_BASEYEAR <- 2025 # base year of SSP data base v3.2
