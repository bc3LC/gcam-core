...
#' module_aglu_LA107.an_Prod_IMAGE_R_C_Sys_Fd_Y
#'
...
#' the generated outputs: \code{L107.an_Prod_Mt_R_C_Sys_Fd_Y} The corresponding file in the
...
module_aglu_LA107.an_Prod_IMAGE_R_C_Sys_Fd_Y <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    return_data(L107.an_Prod_Mt_R_C_Sys_Fd_Y)
  } else {
